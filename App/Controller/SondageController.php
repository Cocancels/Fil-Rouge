...
class SondageController
{
    ...
    {
        $sondageId = $_GET["sondageid"];
        $this->model->deleteSondage($sondageId);
        $questions = $this->model->getQuestion($sondageId);
        foreach ($questions as $question) {
            $this->model->deleteReponses($question->id);
        }
        $this->model->deleteQuestions($sondageId);
    ...
    {
        $sondages = $this->model->sondages();
        require ROOT . "/App/view/home/allSondages.php";
    }
}
